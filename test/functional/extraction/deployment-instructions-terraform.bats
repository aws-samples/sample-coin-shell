...
# bats file_tags=type:functional, suite:generate-deployment-instructions, iac:terraform
...
EOF
    ...
    assert_output --partial "Configuring Terraform input variables"
    ...
    assert_output --partial "# Preparing to run the Terraform"
    assert_output --partial "# Running the Terraform"
