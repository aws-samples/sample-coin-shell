...
@test "CloudFormation app upgrade should not modify files that may have changed during app development" {
...
EOF
    ...
    assert_exists "iac/roots/$firstIacModuleName/cf.yml"
    echo "#bats-upgrade-marker" >> "iac/roots/$firstIacModuleName/cf.yml"
    ...
    run get_last_line_of_file "iac/roots/$firstIacModuleName/cf.yml"
    assert [ "$output" == "#bats-upgrade-marker" ]
